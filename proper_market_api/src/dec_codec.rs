...
pub mod encoder {
    ...
    pub struct DecEncoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Writer<'a> for DecEncoder<P> where P: Writer<'a> + Default {
        #[inline]
    ...
    impl<'a, P> DecEncoder<P> where P: Writer<'a> + Default {
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct DecDecoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Reader<'a> for DecDecoder<P> where P: Reader<'a> + Default {
        #[inline]
    ...
    impl<'a, P> DecDecoder<P> where P: Reader<'a> + Default {
        pub fn wrap(mut self, parent: P, offset: usize) -> Self {
            self.parent = Some(parent);
            self.offset = offset;
            self
